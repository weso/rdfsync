...
g1 = Graph()
g1.parse("files/final.ttl", format="ttl")
iso1 = to_isomorphic(g1)

g2 = Graph()
g2.parse("files/example2.ttl", format="ttl")
...
final_result = in_second
cont = 0
for subject, predicate, object in g2:
    if not (subject, predicate, object) in g1:
